...
<html lang="en">
  ...
  <body>
        ...
        <div class="bg-gd-dusk">
          <div class="hero-static content content-full bg-body-extra-light">
            ...
            <div class="py-4 px-1 text-center mb-4">
              ...
              <h1 class="h3 fw-bold mt-5 mb-2">Welcome to Admin Login</h1>
    ...
    <script src="{{ asset('AdminBackend/assets/js/lib/jquery.min.js') }}"></script>

    <!-- Page JS Plugins -->
    <script src="{{ asset('AdminBackend/assets/js/plugins/jquery-validation/jquery.validate.min.js') }}"></script>

    <!-- Page JS Code -->
    <script src="{{ asset('AdminBackend/assets/js/pages/op_auth_signin.min.js') }}"></script>
