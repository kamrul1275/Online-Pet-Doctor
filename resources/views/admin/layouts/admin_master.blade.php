...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('AdminBackend/assets/media/favicons/favicon.png') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('AdminBackend/assets/media/favicons/favicon-192x192.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('AdminBackend/assets/media/favicons/apple-touch-icon-180x180.png') }}">
    <!-- END Icons -->
    ...
    <link rel="stylesheet" id="css-main" href="{{  asset('AdminBackend/assets/css/codebase.min.css') }}">
  ...
  <body>
      ...
      <aside id="side-overlay">
        ...
        <div class="content-header">
            ...
            <a class="img-link me-2" href="be_pages_generic_profile.html">
              <img class="img-avatar img-avatar32" src="{{ asset('AdminBackend/assets/media/avatars/avatar15.jpg') }}" alt="">
            </a>
            <!-- END User Avatar -->
              ...
              <ul class="nav-users">
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="{{ asset('AdminBackend/assets/media/avatars/avatar3.jpg') }}" alt="">
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="{{ asset('AdminBackend/assets/media/avatars/avatar11.jpg') }}" alt="">
                    <i class="fa fa-circle text-success"></i>
                    <div>Brian Cruz</div>
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="{{ asset('AdminBackend/assets/media/avatars/avatar4.jpg') }}" alt="">
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="{{ asset('AdminBackend/assets/media/avatars/avatar12.jpg') }}" alt="">
                    <div>Justin Hunt</div>
   ...
   @include('admin.body.admin_footer')
    ...
    -->
    <script src="{{ asset('AdminBackend/assets/js/codebase.app.min.js') }}"></script>

    <!-- Page JS Plugins -->
    <script src="{{ asset('AdminBackend/assets/js/plugins/chart.js/chart.min.js') }}"></script>

    <!-- Page JS Code -->
    <script src="{{ asset('AdminBackend/assets/js/pages/be_pages_dashboard.min.js') }}"></script>
