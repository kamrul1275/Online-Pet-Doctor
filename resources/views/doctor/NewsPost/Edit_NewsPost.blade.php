...
<div class="content">
    ...
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Update News Post</h3>
      </div>
      <div class="block-content">


        <form action="{{ route('update.news_post',$NewsPosts->id) }}" method="POST" enctype="multipart/form-data">
         @csrf
          ...
          <div class="row push">
            ...
            <div class="col-lg-8 col-xl-5">
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control" id="heading" value="{{ $NewsPosts->heading }}" name="heading" placeholder="heading Input">
              </div>


              <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Textarea</label>
                <textarea class="form-control" id="example-textarea-input" name="description" value="{{ $NewsPosts->description }}" rows="4" placeholder="Textarea content.."></textarea>
              </div>
