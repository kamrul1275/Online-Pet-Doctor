      ...
      <div class="space-x-1">
        ...
        <div class="dropdown d-inline-block">
          ...
          <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
            ...
            <div class="p-2">
              <a class="dropdown-item d-flex align-items-center justify-content-between space-x-1" href="{{ route('doctor.profile') }}">
                <span>Profile</span>
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item d-flex align-items-center justify-content-between space-x-1" href="{{ route('doctor.logout') }}">
                <span>Sign Out</span>
